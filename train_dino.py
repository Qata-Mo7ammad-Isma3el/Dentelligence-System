...
import models.dino.datasets
from models.dino.datasets import build_dataset, get_coco_api_from_dataset
from models.dino.engine import evaluate, train_one_epoch, test
...
def main(args):
    ...
    data_loader_val = DataLoader(
        dataset_val, 1, sampler=sampler_val, drop_last=False, collate_fn=utils.collate_fn, num_workers=args.num_workers
    )
    ...
    if args.dataset_file == "coco_panoptic":
        ...
        coco_val = models.dino.datasets.coco.build("val", args)
    ...
    if copyfilelist and args.local_rank == 0:
        from models.dino.datasets.data_util import remove

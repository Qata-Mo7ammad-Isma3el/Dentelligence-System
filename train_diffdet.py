...
def register_dentex_quadrant_dataset():
    register_coco_instances(
        ...
        {},
        "/content/drive/MyDrive/dentex_dataset/coco/quadrant/annotations/instances_train2017.json",
        "/content/drive/MyDrive/dentex_dataset/coco/quadrant/train2017",
    )
    register_coco_instances(
        "dentex_quadrant_val",
        {},
        "/content/drive/MyDrive/dentex_dataset/coco/quadrant/annotations/instances_val2017.json",
        "/content/drive/MyDrive/dentex_dataset/coco/quadrant/val2017",
    )
